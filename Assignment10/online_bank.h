...
unsigned int current_day_to_receive=0;
unsigned int current_amount_to_receive=0;
...
void current_data_toReceive(unsigned int current_amount_toReceive);
...
void current_data_toTransfer(unsigned int current_amount_toTransfer){
    ...
    get_time();
    printf("current info : %s : current amount to transfer: %u\n\n",Ctime[0].c_time,current_amount_toTransfer);
...
void current_data_toReceive(unsigned int current_amount_toReceive){
    char get_current_day[2];
    get_time();
    printf("current info : %s : current amount to Receive: %u\n\n",Ctime[0].c_time,current_amount_toReceive);

    get_current_day[0]=Ctime[0].c_time[9];
    get_current_day[1]=Ctime[0].c_time[10];
    unsigned int current_day_to_receiveL = charArray_to_unsigned_fun(get_current_day);

    current_amount_to_receive=current_amount_toReceive;
    current_day_to_receive=current_day_to_receiveL;
